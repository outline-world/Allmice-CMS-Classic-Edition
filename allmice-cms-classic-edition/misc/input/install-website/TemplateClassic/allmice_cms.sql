...
(14, 'User', 'User', 'This module is an extension to the AppUser and Admin modules. It helps to add, edit and delete various user data (including register users with e-mail validation), allows contact forms and other e-mail messages and performs authentication (logging functionality). If using this module, then it is suggested not to use Admin module user event methods.', 'user', '', '', 22, 1, 'mod_user, mod_user_contact, mod_user_country, mod_user_email, mod_user_postal', '#Message#FormField#SystemManager#', '1.6.5', 1567949188, 'A stable module. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, User module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
