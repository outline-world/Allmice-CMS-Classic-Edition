...
(80, 'Page', 'Template (html code with placeholders), that determines, which components of the Page module regular page will be displayed and how.', 'pageView', 'viewTemplate', '[editorData]<h1>[title]</h1>\r\n<div class=\"content-body\">\r\n[body]\r\n</div>'),
...
(1, 'App', 'App', 'This module is part of Allmice CMS Core for installing websites and modules', 'app', '', 'core/modules/', 2, 0, '', '', '1.6.3', 1565214866, 'Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Allmice CMS Core code is released under the \"GNU GENERAL PUBLIC LICENSE\".'),
(2, 'AppUser', 'App User', 'This module is part of Allmice CMS Core for login and logout functionality', 'app-user', '', 'core/modules/', 2, 0, '', '', '1.3.4', 1556155080, 'Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Allmice CMS Core code is released under the \"GNU GENERAL PUBLIC LICENSE\".'),
(3, 'GlobalCore', 'Global Core', 'This module is part of Allmice CMS Core for Allmice CMS core functionality', '', '', 'core/modules/', 1, 0, '', '', '1.6.2', 1564698845, 'Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Allmice CMS Core code is released under the \"GNU GENERAL PUBLIC LICENSE\".'),
(4, 'Admin', 'Admin', 'This module helps to add, edit and delete various admin data for Allmice CMS', 'admin', '', '', 22, 1, '', '', '1.5.10', 1560282326, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Admin module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(5, 'Block', 'Block', 'This module helps to add, edit and delete block data for Allmice CMS core block functionality', 'block', 'modules/Block/config-block.php', '', 22, 1, '', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Block module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(6, 'Menu', 'Menu', 'This is a simple menu module, which includes most common website functionality', 'menu', '', '', 22, 1, 'mod_menu, mod_menu_item', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Menu module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(7, 'SystemManager', 'System Manager', 'This module helps to install, uninstall and update other modules for Allmice CMS. It is an extension of core App module. The updating process (structure events) involves uninstalling and installing modules without deleting and without overwriting data.', 'system-manager', '', '', 22, 1, '', '', '1.5.11', 1560321146, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, System Manager module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(8, 'FormField', 'Form Field', 'This module makes it possible to change some properties of the form fields of module events.', 'form-field', '', '', 22, 1, 'mod_form_field', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Form Field module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(9, 'GlobalObserver', 'Global Observer', 'This is a global module, which records visitors data (including consent signals related to EU General Data Processing Regulation) into database.', '', '', '', 21, 1, 'mod_global_observer_visitor, mod_global_observer_location, mod_global_observer_event', '', '1.5.9', 1559944363, 'A stable module. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, Global Observer module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(10, 'Message', 'Message', 'This message module can be used to manage e-mail, log and other possible messages. It has also methods to manage templates for creating outgoing e-mails or system log messages.', 'message', '', '', 22, 1, 'mod_message, mod_message_template', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Message module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(11, 'Page', 'Page', 'This is a simple page module, which includes most common website functionality. This module has multi language support.', 'page', '', '', 22, 1, 'mod_page, mod_page_post, mod_page_snippet', '#Menu#', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Page module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(12, 'Profile', 'Profile', 'This module helps to customize user&#39;s profile.', 'profile', '', '', 22, 1, 'mod_profile', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Profile module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(13, 'OwnPage', 'Own Page', 'This is a simple page module, which includes most common website functionality. Only the owner of the pages can use the functionality of this module (for other purposes use module Page). This module has multi language support.', 'own-page', '', '', 22, 1, '', '#Menu#Page#', '1.6.4', 1567270806, 'A stable module. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, Own Page module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(14, 'User', 'User', 'This module is an extension to the AppUser and Admin modules. It helps to add, edit and delete various user data (including register users with e-mail validation), allows contact forms and other e-mail messages and performs authentication (logging functionality). If using this module, then it is suggested not to use Admin module user event methods.', 'user', '', '', 22, 1, 'mod_user, mod_user_contact, mod_user_country, mod_user_email, mod_user_postal', '#Message#FormField#SystemManager#', '1.5.10', 1560282326, 'A stable module. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, User module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(15, 'Search', 'Search', 'This is a search module.', 'search', '', '', 22, 1, 'mod_search', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Search module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(16, 'Theme', 'Theme', 'This is theme module', 'theme', '', '', 22, 1, '', '', '1.6.4', 1567270806, 'A stable module. Copyright 2017 - 2019 by Any Outline LTD, www.allmice.com/cms, Theme module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(17, 'Language', 'Language', 'This is a language module, which includes language editing functionality.', 'language', '', '', 22, 1, 'mod_language, mod_language_item', '#Block#Page#', '1.6.4', 1567270806, 'A stable module. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, Language module is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.');
...
(1, 'AllmiceDefault', 'Allmice Default Theme', 'Default theme for Allmice CMS with teal color shades and fixed navibar. This is a mobile-friendly theme.', 'core/themes/', '1.6.3', 1565184360, 'Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, Allmice Default Theme is released under the \"GNU GENERAL PUBLIC LICENSE\".'),
(11, 'ClassicBase', 'Classic Base Theme', 'A changeable base theme for Allmice CMS. In non-mobile device it has left sidebar for menu area. If menu area is not used, then left sidebar is hidden. In case of mobile devices no sidebar will be used and the layout with styles will be in this case mobile device friendly.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(12, 'ClassicBlue', 'Classic Blue Theme', 'A changeable theme for Allmice CMS, which uses Classic Base theme components. In non-mobile device it has two sidebars - left and right. This theme has blue color shades.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(13, 'ClassicCherry', 'Classic Cherry Theme', 'A changeable theme for Allmice CMS, which uses Classic Base theme components. In a non-mobile device it has right sidebar for menu area. If menu area is not used, then right sidebar is hidden. This theme has cherry red color shades.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(14, 'MobileBase', 'Mobile Base Theme', 'A simple mobile friendly Base theme for Allmice CMS.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(15, 'MobileGreen', 'Mobile Green Theme', 'A green version of Mobile Base theme for Allmice CMS.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(16, 'MousyBase', 'Mousy Base Theme', 'A simple modern base theme for Allmice CMS with teal color shades and fixed navibar. In case of mobile devices no sidebar will be used and the layout with styles will be in this case mobile device friendly.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(17, 'MousyBlue', 'Mousy Blue Theme', 'A blue version of Mousy Base theme for Allmice CMS.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.'),
(18, 'MousyGreen', 'Mousy Green Theme', 'A green version of Mousy Base theme for Allmice CMS.', 'themes/', '1.6.3', 1565184360, 'Stable theme. Copyright 2018 - 2019 by Any Outline LTD, www.allmice.com/cms, This theme is released under the &#39;GNU GENERAL PUBLIC LICENSE&#39;.');
