...
class ExtraForm extends Form
{
    ...
    public function __construct()
    {
        ...
        $this->add(array(
            ...
            'value'  => 1,
            'label' => 'Snippet type: ',
				'guide' => 'If type is php code, then the content form field should include location to the php code class, which will return the actual snippet content.',
				'options' => array(
					1 => "Plain text",
					2 => "PHP code",
				),
        ...
        $this->add(array(
            ...
            'label' => 'Snippet content: ',
				'guide' => 'If type is plain text, then content of the snippet. If type is php code, then location of the php code class',
				'required' => false,
				'attributes'  => array(
					'rows' => '6',
					'cols' => '80',
